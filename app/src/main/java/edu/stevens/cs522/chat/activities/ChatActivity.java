...
public class ChatActivity extends AppCompatActivity implements ChatroomsFragment.IChatroomListener, MessagesFragment.IChatListener, SendMessage.IMessageSender {
    ...
    public void send(String chatroom, String message) {
        ...
        ResultReceiverWrapper sendResultReceiver = new ResultReceiverWrapper(new Handler());
        sendResultReceiver.setReceiver(new ResultReceiverWrapper.IReceive() {
            @Override
        ...
        chatHelper.postMessage(chatroom, message, sendResultReceiver);
